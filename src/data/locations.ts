...
export const LOCATIONS: CatalogLocation[] = [
  ...
  { id: 'southafrica-n7-namaqualand', lat: -29.66, lng: 17.89, label: 'N7 through Namaqualand', country: 'South Africa', continent: 'Africa', difficulty: 'hard', tags: [], setting: 'remote', panoId: 'BnxpR4aNTWG7dL3osbzJzQ', panoVerifiedAt: '2026-07-26' },
  { id: 'southafrica-stellenbosch-outskirts', lat: -33.93, lng: 18.86, label: 'Winelands outside Stellenbosch', country: 'South Africa', continent: 'Africa', difficulty: 'normal', tags: [], setting: 'suburban', panoId: 'VpSqHP0_m1w_Ah2s3SWb0w', panoVerifiedAt: '2026-07-26' },
  { id: 'lesotho-a2-mafeteng', lat: -29.82, lng: 27.24, label: 'A2 near Mafeteng', country: 'Lesotho', continent: 'Africa', difficulty: 'hard', tags: [], setting: 'rural', panoId: 'QHJ8W805MDz9x1J-wl0DjQ', panoVerifiedAt: '2026-07-26' },
  { id: 'ghana-n1-takoradi', lat: 4.9, lng: -1.76, label: 'N1 coastal road near Takoradi', country: 'Ghana', continent: 'Africa', difficulty: 'normal', tags: [], setting: 'suburban', panoId: '8yw-sityAwtdv2RPZ2j5vQ', panoVerifiedAt: '2026-07-26' },
  { id: 'newzealand-sh6-haast', lat: -43.88, lng: 169.04, label: 'State Highway 6 near Haast', country: 'New Zealand', continent: 'Oceania', difficulty: 'hard', tags: [], setting: 'rural', panoId: '6k-_awBkZjPoxpa9tguOYQ', panoVerifiedAt: '2026-07-26' },
  { id: 'newzealand-sh1-canterbury', lat: -44.1, lng: 171.24, label: 'State Highway 1, Canterbury Plains', country: 'New Zealand', continent: 'Oceania', difficulty: 'hard', tags: [], setting: 'rural', panoId: '1eAU6XIIqegHswGIPSBvZg', panoVerifiedAt: '2026-07-26' },
  { id: 'chile-ruta5-chanaral', lat: -26.35, lng: -70.62, label: 'Ruta 5 near Chañaral', country: 'Chile', continent: 'South America', difficulty: 'hard', tags: [], setting: 'remote', panoId: 'g7FUWEnZPyVAUifJHch7EQ', panoVerifiedAt: '2026-07-26' },
  { id: 'argentina-ruta3-santacruz', lat: -49.31, lng: -67.73, label: 'Ruta 3 near Puerto San Julián', country: 'Argentina', continent: 'South America', difficulty: 'hard', tags: [], setting: 'remote', panoId: 'hLZwUeSkM9PayxJvu2OV_g', panoVerifiedAt: '2026-07-26' },
  { id: 'argentina-rosario-outskirts', lat: -32.93, lng: -60.68, label: 'Outskirts of Rosario', country: 'Argentina', continent: 'South America', difficulty: 'normal', tags: [], setting: 'suburban', panoId: 'I5I3sbEZkwDmRpdlQDt_bg', panoVerifiedAt: '2026-07-26' },
  { id: 'brazil-minas-rural', lat: -21.13, lng: -44.25, label: 'Farmland in southern Minas Gerais', country: 'Brazil', continent: 'South America', difficulty: 'normal', tags: [], setting: 'rural', panoId: 'avE_Ar4JhLKucthNuSPOMA', panoVerifiedAt: '2026-07-26' },
  { id: 'peru-panamericana-nazca', lat: -14.83, lng: -74.94, label: 'Panamericana Sur near Nazca', country: 'Peru', continent: 'South America', difficulty: 'hard', tags: [], setting: 'remote', panoId: '6wEOoVOTponHYbvcQq28DA', panoVerifiedAt: '2026-07-26' },
  { id: 'uruguay-ruta9-rocha', lat: -34.48, lng: -54.34, label: 'Ruta 9 near Rocha', country: 'Uruguay', continent: 'South America', difficulty: 'normal', tags: [], setting: 'rural', panoId: 'S9C6JHsdlZUA2dimkvXFDg', panoVerifiedAt: '2026-07-26' },
  { id: 'colombia-boyaca-rural', lat: 5.55, lng: -73.36, label: 'Andean farmland in Boyacá', country: 'Colombia', continent: 'South America', difficulty: 'normal', tags: [], setting: 'rural', panoId: 'hHGrwIrTxv5a6VxyGy9MLQ', panoVerifiedAt: '2026-07-26' },
  { id: 'canada-transcanada-swiftcurrent', lat: 50.29, lng: -107.8, label: 'Trans-Canada Highway, Saskatchewan', country: 'Canada', continent: 'North America', difficulty: 'hard', tags: [], setting: 'remote', panoId: 'xUsoLzvKPfchqhIF40f20Q', panoVerifiedAt: '2026-07-26' },
  { id: 'mexico-mex1-catavina', lat: 29.73, lng: -114.72, label: 'Mexico 1 near Cataviña, Baja California', country: 'Mexico', continent: 'North America', difficulty: 'hard', tags: [], setting: 'remote', panoId: 'yUG_-0LzC_X1GAXlwkfkIQ', panoVerifiedAt: '2026-07-26' },
  { id: 'mexico-merida-outskirts', lat: 20.98, lng: -89.62, label: 'Outskirts of Mérida, Yucatán', country: 'Mexico', continent: 'North America', difficulty: 'normal', tags: [], setting: 'suburban', panoId: 'MLy_FIiO-dIESkP3dTN65w', panoVerifiedAt: '2026-07-26' },
  { id: 'japan-hokkaido-biei', lat: 43.59, lng: 142.47, label: 'Rolling farmland near Biei, Hokkaido', country: 'Japan', continent: 'Asia', difficulty: 'hard', tags: [], setting: 'rural', panoId: 'P-7apcUUn5L013sSQjlwNg', panoVerifiedAt: '2026-07-26' },
  { id: 'thailand-1095-pai', lat: 19.36, lng: 98.44, label: 'Route 1095 near Pai', country: 'Thailand', continent: 'Asia', difficulty: 'hard', tags: [], setting: 'rural', panoId: 'jfSIgOuFReig-_qAwRrCaQ', panoVerifiedAt: '2026-07-26' },
  { id: 'indonesia-yogyakarta-outskirts', lat: -7.78, lng: 110.42, label: 'Outskirts of Yogyakarta, Java', country: 'Indonesia', continent: 'Asia', difficulty: 'normal', tags: [], setting: 'suburban', panoId: 'rWQe_mcztSFXMnqAjqfBWA', panoVerifiedAt: '2026-07-26' },
  { id: 'norway-e6-finnmark', lat: 69.47, lng: 25.51, label: 'E6 in Finnmark', country: 'Norway', continent: 'Europe', difficulty: 'hard', tags: [], setting: 'remote', panoId: 'brfx4leWpVejGpi6eFMwnA', panoVerifiedAt: '2026-07-26' },
  { id: 'spain-ronda-countryside', lat: 36.74, lng: -5.16, label: 'Countryside near Ronda, Andalusia', country: 'Spain', continent: 'Europe', difficulty: 'hard', tags: [], setting: 'rural', panoId: 'aQMdugK4F3-PYh0Fzjy7ZQ', panoVerifiedAt: '2026-07-26' },
  { id: 'portugal-n2-alentejo', lat: 37.51, lng: -8.06, label: 'N2 through the Alentejo', country: 'Portugal', continent: 'Europe', difficulty: 'hard', tags: [], setting: 'rural', panoId: 'a0fjzJXlL5tWsuooCeNppQ', panoVerifiedAt: '2026-07-26' },
];
